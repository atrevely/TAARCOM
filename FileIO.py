...
def load_salespeople_info():
    ...
    try:
        ...
        if missing_cols:
            print(f'---\nThe following columns were not found in Salespeople Info: {", ".join(missing_cols)}'
        ...
        print('---\nNo Salespeople Info file found!\n'
              f'Please make sure Salespeople Info.xlsx is in the following directory:\n{location}')
    except XLRDError:
...
def load_principal_info():
    ...
    try:
        ...
        print('---\nNo Principal List file found!\n'
              f'Please make sure Principal Info.xlsx is in the following directory:\n{location}')
    except XLRDError:
...
def load_com_master():
    ...
    print(f'Saving backup as: {run_com_backup}')
    ...
    try:
        ...
        for col in mixed_cols:
            try:
                ...
                print(f'The following column was not found in ENF: {col}'
                      '\nPlease check the column names and try again.')
                return None
        # Now remove the nans.
